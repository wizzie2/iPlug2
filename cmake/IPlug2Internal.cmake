...
macro(_iplug_validate_config_variables _prefix)
    ...
    set(VALIDATION_PLUG_TFLOAT_TYPE         NOTEMPTY DEFAULT "float" STREQUAL float double)
    set(VALIDATION_PLUG_NAME                NOTEMPTY DEFAULT "${PROJECT_NAME}" ALPHA NUMERIC SPACE)
    set(VALIDATION_PLUG_NAME_SHORT          NOTEMPTY ALPHA NUMERIC MINLENGTH 4 MAXLENGTH 4)
    set(VALIDATION_PLUG_CLASS_NAME          NOTEMPTY DEFAULT "${PROJECT_NAME}" ALPHAFIRST ALPHA NUMERIC UNDERSCORE)
    set(VALIDATION_PLUG_MFR                 NOTEMPTY DEFAULT "AcmeInc" MAXLENGTH 127)
    set(VALIDATION_PLUG_VERSION_STR         NOTEMPTY DEFAULT "1.0.0" NUMERIC VERSION 3)
    set(VALIDATION_PLUG_UNIQUE_ID           NOTEMPTY SINGLE_QUOTED ALPHA NUMERIC MAXLENGTH 4)
    set(VALIDATION_PLUG_MFR_ID              NOTEMPTY DEFAULT "'Acme'" SINGLE_QUOTED ALPHA NUMERIC MAXLENGTH 4)
    set(VALIDATION_PLUG_CHANNEL_IO          NOTEMPTY DEFAULT "0-2" NUMERIC HYPHEN DOT SPACE)
    set(VALIDATION_PLUG_HOST_RESIZE         NOTEMPTY DEFAULT "0" STREQUAL 0 1)
    set(VALIDATION_PLUG_TYPE                NOTEMPTY DEFAULT "Effect" STREQUAL Effect Instrument MIDIEffect)
    set(VALIDATION_BUNDLE_DOMAIN            NOTEMPTY DEFAULT "com" ALPHAFIRST ALPHA NUMERIC HYPHEN)
    set(VALIDATION_BUNDLE_NAME              NOTEMPTY DEFAULT "${PROJECT_NAME}" ALPHAFIRST ALPHA NUMERIC HYPHEN)
