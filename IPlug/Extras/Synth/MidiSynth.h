...
#pragma mark - MidiSynth class
 ...
 private:
	...
	inline bool IsMasterChannel(int c) const
	{
		return ((c == 0) || (c == 15));
	}
	bool IsInLowerZone(int c) const
	{
		return ((c > 0) && (c < mMPELowerZoneChannels));
	}
	bool IsInUpperZone(int c) const
	{
